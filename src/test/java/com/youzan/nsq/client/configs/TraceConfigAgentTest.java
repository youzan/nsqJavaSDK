...
//import com.youzan.configs.client.ConfigClient;
//import com.youzan.configs.client.ConfigClientBuilder;
//import com.youzan.configs.client.entity.config.Config;
//import com.youzan.configs.client.entity.config.ConfigRequest;
//import com.youzan.configs.client.entity.config.interfaces.IResponseCallback;
//import com.youzan.configs.client.exceptions.ConfigParserException;
//import com.youzan.configs.client.exceptions.InvalidConfigException;
//import com.youzan.configs.client.util.inetrfaces.ClientConfig;
...
////        NSQConfig.setConfigAgentBackupPath(props.getProperty("backupFilePath"));
////        ConfigAccessAgent cAgentMgr = ConfigAccessAgent.getInstance();
...
////    @Test
////    /**
////     * update lookup address in configs, sdk need to catch the new lookup addresses
////     */
...
////        Assert.assertEquals(lookupAddr[0], "http://sqs-qa.s.qima-inc.com:4161");
////
////        //update kookup address in configs
////        CountDownLatch latch = publishLookupAddress(props.getProperty("nsq.app.val"), props.getProperty("nsq.lookupd.addr.key"), props.getProperty("nsq.configs.env"),
...
////        latch =  deleteLookupAddress(props.getProperty("nsq.app.val"), props.getProperty("nsq.lookupd.addr.key"), props.getProperty("nsq.configs.env"), new String[]{"addr1", "addr2"});
////        Assert.assertTrue(latch.await(5, TimeUnit.SECONDS));
////
////        logger.info("Sleep for 5 seconds to wait for lookup update...");
////        Thread.sleep(5000L);

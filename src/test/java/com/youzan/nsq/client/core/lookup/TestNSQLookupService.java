...
//        try (LookupServiceImpl srv = new LookupServiceImpl( Role.Producer)) {
...
//        lsi = new LookupServiceImpl(Role.Consumer);
//
...
//        LookupServiceImpl lsi = new LookupServiceImpl(Role.Producer);
//
...
//        try (LookupServiceImpl srv = new LookupServiceImpl(null)) {
